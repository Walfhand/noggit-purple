...
check_cxx_compiler_flag ("-Wno-template-body" CXX_COMPILER_SUPPORTS__Wno_template_body)
if (CXX_COMPILER_SUPPORTS__Wno_template_body)
  target_compile_options (sane-sol2 INTERFACE $<$<COMPILE_LANGUAGE:CXX>:-Wno-template-body>)
endif ()
