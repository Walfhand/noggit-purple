...
bool MapChunk::canSetGroundEffectForTexture(std::string const& texture_filename, unsigned int effect_id, bool overwrite) const
{
    return texture_set && texture_set->canSetEffectForTexture(texture_filename, effect_id, overwrite);
}

bool MapChunk::setGroundEffectForTexture(std::string const& texture_filename, unsigned int effect_id, bool overwrite)
{
    return texture_set && texture_set->setEffectForTexture(texture_filename, effect_id, overwrite);
}
