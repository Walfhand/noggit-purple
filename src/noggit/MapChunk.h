...
public:
  ...
  bool canSetGroundEffectForTexture(std::string const& texture_filename, unsigned int effect_id, bool overwrite) const;
  bool setGroundEffectForTexture(std::string const& texture_filename, unsigned int effect_id, bool overwrite);
