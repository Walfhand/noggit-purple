...
public:
  ...
  bool canSetEffectForTexture(std::string const& texture_filename, unsigned int value, bool overwrite) const;
  bool setEffectForTexture(std::string const& texture_filename, unsigned int value, bool overwrite);
  bool setEffect(size_t id, unsigned int value);
