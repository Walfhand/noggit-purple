...
namespace Noggit
{
  namespace Ui
  {
    ...
    enum class ground_effect_apply_scope
    {
      current_zone,
      current_area,
      current_adt,
    ...
    public:
      ...
      bool override_existing_effects() const;
      std::optional<unsigned int> selectedGroundEffectId();
      void refreshRenderOverlay();
    ...
    private:
      ...
      bool addGroundEffectById(unsigned int effect_id);
      void loadGroundEffectsFromDbc();
      void applyGroundEffectToTexture(ground_effect_apply_scope scope);
