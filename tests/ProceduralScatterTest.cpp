...
int main()
{
  auto specification = nlohmann::json::parse(R"({
    "seed":"jungle-v1",
    "assets":[
      {"path":"world/tree.m2","weight":3,"min_scale":0.8,"max_scale":1.2},
      {"path":"world/rock.wmo","weight":1,"min_scale":0.9,"max_scale":1.1}
    ],
    "regions":[{
      "name":"jungle","points":[{"u":0.1,"v":0.1},{"u":0.9,"v":0.1},{"u":0.9,"v":0.9},{"u":0.1,"v":0.9}],
